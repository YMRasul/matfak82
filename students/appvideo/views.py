...
def get_list_video(request):
    return render(request, 'appvideo/video_hosting/home.html', {'video_list': Video.objects.all()})

def get_video(request, pk: int):
    _video = get_object_or_404(Video, id=pk)
    return render(request, "appvideo/video_hosting/video.html", {"video": _video})
